...
class DatabaseService {
  ...
  /// Method to fetch all users with embeddings from Firestore
  Future<QuerySnapshot> getAllUsers() async {
    try {
  ...
  /// Method to fetch a specific user by their ID from Firestore
  ...
  /// Method to update the attendance of a recognized user
  Future<void> updateAttendance({
    required String employeeId,
    required bool isCheckIn,
    ...
    try {
      ...
      print('Attendance updated successfully for user $employeeId');
    } catch (e) {
      print('Error updating attendance: $e');
      throw Exception('Error updating attendance');
    }
  }
  ...
  /// Method to update user embeddings
  Future<void> updateUserEmbeddings(
      String userId, List<Map<String, dynamic>> embeddings) async {
    try {
      await _firestore.collection('users').doc(userId).update({
        'embeddings': embeddings,
      });
      print('Embeddings updated for user $userId');
    } catch (e) {
      print('Error updating embeddings: $e');
      throw Exception('Error updating embeddings');
    }
  }
}
